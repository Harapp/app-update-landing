...
<head>
    ...
    <style>
        ...
        main { box-sizing: border-box; width: min(100% - 2rem, 36rem); margin: 2rem auto; overflow: hidden; border-radius: 1rem; background: #fff; box-shadow: 0 0.5rem 2rem #2021241f; }
        ...
        .update-link { display: inline-flex; flex-direction: column; align-items: center; min-width: 12rem; margin-top: 1rem; padding: .8rem 1.25rem; border-radius: .6rem; background: #14532d; color: #fff; font-weight: 700; text-decoration: none; }
        .update-link small { margin-top: .2rem; font-size: .9rem; }
        .notice { margin: 1.5rem 0 0; color: #374151; font-size: .85rem; }
    </style>
</head>
<body>
<main>
